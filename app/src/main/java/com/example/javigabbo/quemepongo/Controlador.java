...
public class Controlador implements View.OnClickListener{
    ...
    public Controlador(MainActivity view){
        this.vista = view;
        //intent = new Intent(vista, Activity2.class)
    }
    ...
    public void registrarse(String email, String password){
        ...
        vista.firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener((Executor) this, new OnCompleteListener<AuthResult>() {
            @Override
